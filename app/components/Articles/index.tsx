...
const postData: DataType[] = [
    {
        time: "5 min",
        heading: 'Comment utiliser une bouteille de gaz',
        name: "Publié sur facebook",
        date: '20 Septembre 2023',
        imgSrc: '/images/articles/article.png',
    },
    {
        time: "5 min",
        heading: "Les danger et risques d'utilisation",
        name: "Publié sur facebook",
        date: '20 Septembre 2023',
        imgSrc: '/images/articles/article.png',
    },
    {
        time: "5 min",
        heading: 'Comment entretenir mes ustinsils',
        name: "Publié sur facebook",
        date: '20 Septembre 2023',
        imgSrc: '/images/articles/article.png',
    },
            ...
            <div className="bg-lightgrey py-20" id="blog-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="text-3xl sm:text-6xl font-bold">Nos derniers articles.</h3>
                    </div>
                        ...
                        {postData.map((items, i) => (
                            <div key={i} >
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-10 shadow-lg rounded-3xl relative'>
                                    ...
                                    <Link href="/">
                                        <h3 className="absolute bg-blue text-white hover:bg-black hover:shadow-xl py-3 px-6 rounded-full article-img">lecture {items.time}</h3>
                                    </Link>
