...
const postData: DataType[] = [
    {
        ...
        name: 'Lamine Youssouf',
        imgSrc: '/images/wework/avatar.jpeg',
    },
    {
        profession: 'DG',
        name: '@Nom prenom',
        imgSrc: '/images/wework/avatar2.webp',
    },
    {
        profession: 'DGA',
        name: '@Nom prenom',
            ...
            <div className="bg-wework py-32">
                ...
                <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        <h3 className="text-4xl sm:text-6xl font-bold text-gold my-2">L'équipe ZamaniGaz</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold text-blue opacity-50 lg:mr-48 my-2">L'équipe ZamaniGaz</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold text-black opacity-25 lg:-mr-32 my-2">L'équipe ZamaniGaz</h3>
                    </div>
