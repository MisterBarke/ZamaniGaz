...
const postData: DataType[] = [
    {
        heading: 'Livraison de bouteille à domicile.',
        imgSrc: '/images/featured/feat1.jpeg',
    },
    {
        heading: "Kit d'installation",
        imgSrc: '/images/featured/feat3.jpeg',
    },
    {
        heading: 'Livraison de bouteille à domicile.',
        imgSrc: '/images/featured/feat1.jpeg',
            ...
            <div className="bg-bgblue py-20 marginFeature bg-featured">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center pt-48 pb-10 md:pt-96">
                        <h3 className="text-4xl sm:text-6xl font-bold text-white my-2">Nos services.</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold text-white text-opacity-50 lg:mr-48 my-2">Nos services.</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold text-white text-opacity-25 lg:-mr-32 my-2">Nos services.</h3>
                    </div>
